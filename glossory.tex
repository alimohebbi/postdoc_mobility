...
\newcommand{\addrReproduction}{\href{}{}\@\xspace}
...
\newcommand{\projecttitle}{Highly Intelligent Test Reuse\@\xspace}
\newcommand{\imagelabeler}{\texttt{Image Labeler}\@\xspace}
\newcommand{\JS}{{\tt Jaccard Similarity}\@\xspace}
\newcommand{\llmtool}{{\texttt{Hermes}}\@\xspace}
\newcommand{\llmtranslator}{{\texttt{LLM Translator}}\@\xspace}
...
\newcommand{\rlaganet}{{\texttt{RL Agent}}\@\xspace}
\newcommand{\rlaganets}{{\texttt{RL Agents}}\@\xspace}
\newcommand{\rltool}{{\texttt{Athena}}\@\xspace}
...
\newcommand{\visiontool}{\texttt{Horus}\@\xspace}
